...
<body>
    ...
    <div class="nav-drawer" id="navDrawer">
        ...
        <!-- Clickable drawer profile link (matches dashboard.blade.php) -->
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 page-header">
            ...
            <button class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#addUserModal" style="background-color:#2980b9;color:white;">
